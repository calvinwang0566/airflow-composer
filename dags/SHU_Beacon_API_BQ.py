...
url = 'https://shuuemurabc.lorealluxe.com.tw'
...
def get_trigger_record_to_csv(url, headers=None, json=None, **context):
    ...
    csv_file_path = 'SHU_beacon_get_trigger.csv'
...
def data_to_gcs(**context):
    ...
    gcs_hook.upload(
            ...
            object_name='SHU_beacon_get_trigger.csv', 
            filename='SHU_beacon_get_trigger.csv'
        )
...
with DAG(dag_id='SHU_beacon_api_data_connection', 
    ...
    gcs_to_bq_flow = GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects = ['SHU_beacon_get_trigger.csv'],
        source_format = 'CSV',
        skip_leading_rows = 1,
